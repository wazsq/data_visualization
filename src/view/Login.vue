...
<template>
    <div class="login" id="login">
        ...
        <div class="log-bg">
            ...
            <div class="log-logo">餐饮数据分析系统</div>
            <div class="log-text">宋成恩</div>
            <div class="log-text">邵一笑</div>
            <div class="log-text">{{ new Date() }}</div>
        </div>
        <div class="log-email">
            <input type="text" placeholder="Account" :class="'log-input' + (account==''?' log-input-empty':'')"
...
<script>
    ...
    import commentDataHandler from './../assets/js/CommentDataHandler';
        ...
        methods: {
            ...
            login() {
                if (this.account != '' && this.password != '') {
                    ...
                    this.$message.error('用户名和密码为任意字符串');
                }
            },
            //登录请求
            toLogin() {
                ...
                setTimeout(() => {
                    ...
                    if (!this.$store.getters.hasCommentData) {
                        this.$store.commit('setCommentData', commentDataHandler.getShopQuantityBySeason())
                    }
                    this.isLoging = false;
